<?php
	...
	class ArrangementsController extends Controller {
		...
		public function __construct() {
			echo $this->setHeader( array('app.less'), array('jquery', 'app.coffee', 'arrange.coffee') );
		...
		public function index() {
			...
			foreach ( $boats as $id_boat => $boat ) {
				...
				if ( !($boat_idx++ % 5) )  {
					self::$tpl->boatList .= '</div><div class="boatLine">';
				}
			}
			self::$tpl->boatList = '<div class="boatLine">' . self::$tpl->boatList . '</div>';
